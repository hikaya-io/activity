...
class IndicatorDataTable(tables.Table):
    ...
    indicator__name = tables.LinkColumn('indicator_data_report', args=[
                                        A('indicator__id'), A('indicator__program__id'), 0])
    ...
    class Meta:
        ...
        fields = ('indicator__lop_target', 'actuals',
                  'indicator__program__name', 'indicator__number', 'indicator__name')
...
class CollectedDataTable(tables.Table):
    ...
    class Meta:
        ...
        sequence = ('targeted', 'achieved', 'description', 'logframe_indicator',
                    'sector', 'community', 'agreement', 'complete')
