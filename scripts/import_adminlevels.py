...
def getAllData(getCountry, file_name):
    ...
    with open(file_name, 'rb') as csvfile2:
        ...
        for row in country2:
            ...
            for column in row:
                if column_num == 1:
                    getProvince = Province.objects.get(
                        name=column, country=getCountry)
                ...
                if column_num == 2:
                    ...
                    try:
                        ...
                        new_district = District(
                            name=column, province=getProvince)
                        new_district.save()
    ...
    with open(file_name, 'rb') as csvfile2:
        ...
        for row in country2:
            ...
            for column in row:
                ...
                if column_num == 2:
                    getDistrict = District.objects.get(
                        name=column, province=getProvince)
        ...
        for row in country2:
            ...
            for column in row:
                ...
                if column_num == 4:
                    ...
                    try:
                        Village.objects.get(
                            name=column, admin_3=getAdminLevel3)
