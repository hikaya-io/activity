...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('targeted', models.DecimalField(blank=True, decimal_places=2, default=Decimal('0.00'), max_digits=20, null=True, verbose_name='Targeted')),
                ('achieved', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True, verbose_name='Achieved')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(blank=True, help_text=' ', max_length=255, null=True, verbose_name='Data source')),
                ('definition', models.TextField(blank=True, help_text=' ', null=True)),
                ('justification', models.TextField(blank=True, help_text=' ', max_length=500, null=True, verbose_name='Justification for indicator')),
                ...
                ('lop_target', models.CharField(blank=True, help_text=' ', max_length=255, null=True, verbose_name='Overall target')),
                ('rationale_for_target', models.TextField(blank=True, help_text=' ', max_length=255, null=True)),
                ('target_frequency', models.IntegerField(blank=True, choices=[(1, 'Life of Program only'), (2, 'Midline and endline'), (3, 'Annual'), (4, 'Semi-annual'), (5, 'Tri-annual'), (6, 'Quarterly'), (7, 'Monthly'), (8, 'Event')], help_text=' ', null=True, verbose_name='Target frequency')),
                ...
                ('means_of_verification', models.CharField(blank=True, help_text=' ', max_length=255, null=True, verbose_name='Means of verification')),
                ...
                ('responsible_person', models.CharField(blank=True, help_text=' ', max_length=255, null=True, verbose_name='Responsible person or team')),
