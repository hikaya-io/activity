    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(blank=True, null=True)),
                ('edit_date', models.DateTimeField(blank=True, null=True)),
                ('initiation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                 to='workflow.ProjectAgreement', verbose_name='Project Initiation')),
                ('office_code', models.ForeignKey(blank=True, null=True,
                                                  on_delete=django.db.models.deletion.CASCADE, to='workflow.Office')),
                ...
                ('province', models.ForeignKey(blank=True, null=True,
                                               on_delete=django.db.models.deletion.CASCADE, to='workflow.Province')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, to='formlibrary.Distribution'),
        ),
        migrations.AddField(
            model_name='beneficiary',
            name='program',
        ...
        migrations.AddField(
            ...
            name='training',
            field=models.ManyToManyField(
                blank=True, to='formlibrary.TrainingAttendance'),
        ),
    ]
