...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=135, null=True, verbose_name='Document Name')),
                ('url', models.CharField(blank=True, max_length=135, null=True, verbose_name='URL (Link to document or folder)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_url', models.CharField(blank=True, max_length=255, null=True, verbose_name='URL')),
                ('activity_url', models.CharField(blank=True, max_length=255, null=True, verbose_name='Activity URL')),
                ('location', models.CharField(blank=True, max_length=255, null=True, verbose_name='Location')),
                ('level_1_label', models.CharField(blank=True, default='Programs', max_length=255, verbose_name='Project/Program Organization Level 1 label')),
                ('level_2_label', models.CharField(blank=True, default='Projects', max_length=255, verbose_name='Project/Program Organization Level 2 label')),
                ('level_3_label', models.CharField(blank=True, default='Components', max_length=255, verbose_name='Project/Program Organization Level 3 label')),
                ('level_4_label', models.CharField(blank=True, default='Activities', max_length=255, verbose_name='Project/Program Organization Level 4 label')),
                ('site_label', models.CharField(default='Locations', max_length=255, verbose_name='Site Organization label')),
                ('stakeholder_label', models.CharField(default='Stakeholders', max_length=255, verbose_name='Stakeholder Organization label')),
                ('form_label', models.CharField(default='Forms', max_length=255, verbose_name='Form Organization label')),
                ('indicator_label', models.CharField(default='Indicators', max_length=255, verbose_name='Indicator Organization label')),
                ...
                ('logo', models.ImageField(blank=True, help_text='Image of minimum 2000 width and 500 height, maximum of 100 ko', upload_to='images/', validators=[workflow.models.validate_image], verbose_name='Your Organization logo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('program_uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True, verbose_name='Program UUID')),
                ('name', models.CharField(default='Default Level 1', max_length=255, verbose_name='Program Name')),
                ('funding_status', models.CharField(blank=True, choices=[('open', 'Open'), ('in_negotiation', 'In Negotiation'), ('signed', 'Signed'), ('Awarded', 'Awarded'), ('Closed', 'Closed')], default='open', max_length=255, verbose_name='Funding Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approval', models.CharField(blank=True, choices=[('new', 'new'), ('in progress', 'in progress'), ('awaiting approval', 'awaiting approval'), ('approved', 'approved'), ('rejected', 'rejected'), ('Not approved', 'not approved')], default='new', max_length=255, null=True, verbose_name='Approval Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ManyToManyField(blank=True, max_length=255, related_name='stakeholder_contacts', to='workflow.Contact')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.DecimalField(blank=True, decimal_places=16, default=Decimal('0.00'), max_digits=25, null=True, verbose_name='Latitude')),
                ('longitude', models.DecimalField(blank=True, decimal_places=16, default=Decimal('0.00'), max_digits=25, null=True, verbose_name='Longitude')),
                ...
                ('organizations', models.ManyToManyField(blank=True, related_name='organizations', to='workflow.Organization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_agreement', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='project_complete', to='workflow.ProjectAgreement', verbose_name='Project Initiation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='org_groups', to='auth.Group', verbose_name='Organization Group')),
